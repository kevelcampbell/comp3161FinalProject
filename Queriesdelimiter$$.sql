...
DELIMITER $$
CREATE PROCEDURE AddPhoto (@photo_id VARCHAR(100),@user_id int(100),@photo_name VARCHAR(100),@photo_image BLOB,@photo_datetime DATETIME)
BEGIN
...
DELIMITER $$
CREATE PROCEDURE AddGroupPhoto(@photo_id VARCHAR(100),@group_id VARCHAR(100))
BEGIN
...
DELIMITER $$
CREATE PROCEDURE AddGroupPost (@post_id VARCHAR,@group_id VARCHAR(100))
BEGIN
